...
class SoftmaxAccuracyEvaluator:
    """
    ...
    def __init__(self, sentence_pairs: List[List[str]], labels: List[int], name: str=''):
        ...
        self.csv_file = "SoftmaxAccuracyEvaluator" + ("_" + name if name else '') + "_results.csv"
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int = -1) -> float:
        ...
        logging.info("SoftmaxAccuracyEvaluator: Evaluating the model on " + self.name + " dataset" + out_txt)
