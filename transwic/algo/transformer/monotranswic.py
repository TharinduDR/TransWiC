...
from transwic.algo.transformer.model_args import MonoTransWiCArgs
from transwic.algo.transformer.models.albert_model import AlbertForSequenceClassification
from transwic.algo.transformer.models.bert_model import BertForSequenceClassification
from transwic.algo.transformer.models.camembert_model import CamembertForSequenceClassification
from transwic.algo.transformer.models.distilbert_model import DistilBertForSequenceClassification
from transwic.algo.transformer.models.electra_model import ElectraForSequenceClassification
from transwic.algo.transformer.models.flaubert_model import FlaubertForSequenceClassification
from transwic.algo.transformer.models.layoutlm_model import LayoutLMForSequenceClassification
from transwic.algo.transformer.models.roberta_model import RobertaForSequenceClassification
from transwic.algo.transformer.models.xlm_model import XLMForSequenceClassification
from transwic.algo.transformer.models.xlm_roberta_model import XLMRobertaForSequenceClassification
from transwic.algo.transformer.models.xlnet_model import XLNetForSequenceClassification
from transwic.algo.transformer.utils import (
    InputExample,
...
class MonoTransWiCModel:
    def __init__(
        ...
        elif isinstance(args, MonoTransWiCArgs):
            self.args = args
        ...
        if self.args.tagging:
            ...
            self.model.bert.embeddings.word_embeddings.weight[-2, :] = torch.zeros(
                [self.model.bert.config.hidden_size])
